...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명.
        *   예외처리를 가장 많이 사용하게 되는 상황(io 패키지 관련) 에서 try-catch 구문을 실제 상황과  유사하게 연습해 보자.
        ...
        try {
            ...
            * */
            try {
                ...
                /* 필기.
                *   스트림(입출력 관련 통로)이 생성되지 않았을 때 접근해서 close() 메서드를 호출하게 되면
                *   NullPointerException이 발생할 수 있다. 따라서 if문을 활용해 처리한다.
                * */
                if (br != null){

                    /* 필기.
                    *   입출력에서 사용한 스트림을 닫아주는 메서드이다.
                    *   API에서 확인해보면 IOException을 throws하는 메서드이기 때문에
