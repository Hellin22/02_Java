...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 수업목표. String 클래스의 자주 사용하는 메서드에 대해 숙지하고 응용할 수 있다. */
        ...
        /* 필기. comapreTo(): 인자로 전달된 문자열과 사전 순으로 비교 */
        String str2 = "java";
        String str3 = "java";
        String str4 = "JAVA";
        String str5 = "mariaDB";
        ...
        /* 필기. trim(): 문자열의 앞 뒤에 공백을 제거한 문자열 반환 */
        String trimStr = "    java    ";
        ...
        * */
        ...
        /* 필기. substring(): 문자열의 일부분을 잘라내 새로운 문자열 반환 */
        ...
        /* 필기. isEmpty(): 문자열의 길이가 0이면 true, 아니면 false를 반환(null과 다르다.) */
