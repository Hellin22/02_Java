...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 수업목표. 문자열 객체를 생성하는 다양한 방법을 숙지하고
            인스턴스가 생성되는 방식을 이해할 수 있다.*/
        /* 필기.
        *   문자열 객체 만드는 방법
        *   1. "" 리터럴 형태: 동일한 값을 가지는 인스턴스(동등(hashCode, equals)를 단일 인스턴스로 관리한다.
        *       (singleton 개념, heap 영역의 상수 풀(constant pool) 활용)
        ...
        * */
        ...
        System.out.println(a.replace("av", "ab"));
