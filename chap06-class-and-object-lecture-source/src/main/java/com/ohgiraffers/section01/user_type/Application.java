...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
         *    이렇게 변수들로만 관리할 때 발생할 수 있는 문제점 / 클래스의 장점
         *    1. 많은 변수명들을 관리하기 힘들 수 있다.
         *    2. 메서드의 전달인자로 전달할 값이 너무 많아 회원과 관련된 기능을 호출할 때 매개변수가 많아진다.(나쁜 냄새)
         *    3. 메서드의 반환형으로 회원이라는 개념을 반환할 수 없다. (메서드의 반환형은 하나이기 때문)
         * */

        /* 설명. 두 명의 회원 객체를 만들어 각각 다른 이름을 부여해보기 */
        ...
        /* 설명. 또한 메서드의 반환형으로 한번에 회원정보를 반환할 수 있고 반환된 객체에 접근도 가능하다. */
