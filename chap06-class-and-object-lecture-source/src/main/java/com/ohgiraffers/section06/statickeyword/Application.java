...
public class Application {
    public static void main(String[] args) {
        ...
        /* 필기.
         *  static
         *  : 프로그램이 실행될 때 정적 메모리 영역(static 영역 or 클래스 영역)에 할당하는 키워드이다.
        ...
        System.out.println("non-static field: " + st2.getNonStaticCount()); // 아마 이건 0일거다.
        System.out.println("static field: " + StaticTest.getStaticCount()); // 이건 앞에꺼랑 같을거다.
