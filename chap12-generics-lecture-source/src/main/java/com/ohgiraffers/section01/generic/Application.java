...
public class Application {
    public static void main(String[] args) {
        ...
        // (Double)형으로 다운캐스팅을 해야하지만 (String)으로 다운캐스팅도 컴파일 시점에 가능해지고
        // 이는 런타임에러를 발생시킨다.(Object를 활용한 것은 자료형이 안전하지 않다.)


//        GenericTest<Integer> gt1 = new GenericTest<Integer>();
        GenericTest<Integer> gt1 = new GenericTest<>(); // 객체의 생성자 부분에는 빈 다이아몬드 연산자 허용

//        String strResult = gt1.getValue();            // 컴파일 시점에 컴파일 에러로 인해 타입을 체크할 수 있다.
