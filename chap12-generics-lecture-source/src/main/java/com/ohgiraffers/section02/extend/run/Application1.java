...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 수업목표. extends 키워드를 사용하여 특정 타입만 제네릭 타입으로 사용하도록 제한 가능 */
        /* 설명. Rabbit이거나 Rabbit의 자식 타입이 아닌 타입으로 제네릭 타입을 지정하면 컴파일 에러 발생 */
//        RabbitFarm<Animal> farm1 = new RabbitFarm<>();
//        RabbitFarm<Mammal> farm2 = new RabbitFarm<>();
//        RabbitFarm<Snake> farm3 = new RabbitFarm<>();

        /* 설명. Rabbit 또는 Rabbit의 자식(하위) 타입으로는 인스턴스 생성 가능(<T extends Rabbit>) */
